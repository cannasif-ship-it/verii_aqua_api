...
namespace aqua_api.Migrations
{
    ...
    [Migration("20260222215052_EnforceSingleGoodsReceiptPerProject")]
    partial class EnforceSingleGoodsReceiptPerProject
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("aqua_api.Models.BatchMovement", b =>
                {
                    ...
                    b.ToTable("RII_BatchMovement", null, t =>
                        {
                            t.HasCheckConstraint("CK_RII_BatchMovement_MovementType", "[MovementType] IN (0,1,2,3,4,5)");
                        });
                });
            ...
            modelBuilder.Entity("aqua_api.Models.NetOperationLine", b =>
                {
                    ...
                    b.ToTable("RII_NetOperationLine", null, t =>
                        {
                            t.HasCheckConstraint("CK_RII_NetOperationLine_Quantity", "[Quantity] > 0");
                        });
                });
