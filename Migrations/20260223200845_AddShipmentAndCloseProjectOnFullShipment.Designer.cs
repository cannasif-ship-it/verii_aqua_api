...
namespace aqua_api.Migrations
{
    ...
    [Migration("20260223200845_AddShipmentAndCloseProjectOnFullShipment")]
    partial class AddShipmentAndCloseProjectOnFullShipment
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("aqua_api.Models.BatchMovement", b =>
                {
                    ...
                    b.ToTable("RII_BatchMovement", null, t =>
                        {
                            t.HasCheckConstraint("CK_RII_BatchMovement_MovementType", "[MovementType] IN (0,1,2,3,4,5,6)");
                        });
                });
