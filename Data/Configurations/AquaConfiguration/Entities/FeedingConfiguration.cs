...
namespace aqua_api.Data.Configurations
{
    public class FeedingConfiguration : BaseEntityConfiguration<Feeding>
    {
        protected override void ConfigureEntity(EntityTypeBuilder<Feeding> builder)
        {
            ...
            builder.HasCheckConstraint("CK_RII_Feeding_Slot", "[FeedingSlot] IN (0,1)");
            builder.HasCheckConstraint("CK_RII_Feeding_Status", "[Status] IN (0,1,2)");
