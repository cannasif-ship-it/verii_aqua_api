...
namespace aqua_api.Controllers.AquaController
{
    ...
    public class ProjectController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<ActionResult<ApiResponse<PagedResponse<ProjectDto>>>> GetAll([FromQuery] PagedRequest request)
        {
        ...
        [HttpPut("{id:long}")]
        public async Task<ActionResult<ApiResponse<ProjectDto>>> Update(long id, [FromBody] UpdateProjectDto dto)
